const openSource = {
  githubConvertedToken: "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",
...
const query_repository_details = {
  query: `
  query MyQuery {
    repository(name: "invoice-app-server", owner: "vjcvl") {
      id
      allowUpdateBranch
      createdAt
      description
...
fetch(baseUrl, {
  method: "POST",
  headers: headers,
  body: JSON.stringify(query_repository_details),
})
